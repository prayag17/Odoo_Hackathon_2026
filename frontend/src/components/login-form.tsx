      ...
      <FieldGroup>
        ...
        <Field>
          <div className="flex items-center">
            ...
            <button
              ...
              onClick={() =>
                toast.info('Password reset is unavailable', {
                  description: 'The email system is currently offline. Please contact an administrator to reset your password.',
                })
              }
            >
        ...
        <Field>
          <Button type="submit" disabled={signInMutation.isPending}>
            {signInMutation.isPending && <Spinner data-icon="inline-start" />}
